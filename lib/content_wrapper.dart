...
class _ContentWrapperState extends State<ContentWrapper>
  ...
  void initState() {
    ...
    _destinationKeys = List<Key>.generate(
      widget.navbarDestinations.length,
      (int index) => GlobalKey(),
    ).toList();
                    ...
                    child: Stack(
                      children: widget.navbarDestinations
                        ...
                        final Widget view = FadeTransition(
                          ...
                          ), //set opacity according to animation
                          child: KeyedSubtree(
                        ...
                        if (destination.index == _currentIndex) {
                          ...
                          return Offstage(
                            child: view,
                          ); //move offstage to ensure they aren't painted when not visible
                        }
                      }).toList(),
                    ),
                  ),
            ...
            bottomNavigationBar: BottomAppBar(
              ...
              child: FsekAppBar(
                ...
                onTabSelected: (int? index) {
                  ...
                  widget.onNavigation!.add(
                    widget.navbarDestinations[_currentIndex].widget.runtimeType,
                  );
                },
                items: [
