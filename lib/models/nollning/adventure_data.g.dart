...
AdventureData _$AdventureDataFromJson(Map<String, dynamic> json) {
  return AdventureData()
    ...
    ..adventures = (json['adventures'] as Map<String, dynamic>?)?.map(
      (k, e) => MapEntry(k, (e as List<dynamic>).map((e) => AdventureMissionWeek.fromJson(e as Map<String, dynamic>)).toList()),
    );
}

Map<String, dynamic> _$AdventureDataToJson(AdventureData instance) => <String, dynamic>{
