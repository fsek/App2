...
final ThemeData themeN = ThemeData(
  ...
  colorScheme: ColorScheme.fromSeed(
    ...
    onPrimaryContainer: Colors
        .black, // colors.green[700], // (only) Used for a selected element in the bottom bar
    primary: const Color.fromRGBO(56, 142, 60,
        1), // colors.green[700], used often and in random places, this is a remnant from the old theme
  ...
  primaryColorLight:
      Colors.green[800], // Used for the banner/background on the contact page
  ...
  textTheme: TextTheme(
    displayMedium: const TextStyle(
      // Used for the text on the loading widget
      fontSize: 30,
      fontWeight: FontWeight.normal,
    ),
    titleLarge: const TextStyle(
        // Ex: all titles on top bar, titles of gallery albums, titles of news after tapping them
        fontSize: 22,
        fontStyle: FontStyle.normal,
        color: Colors
            .white // This color is not inhereted by the titles on the top bar
        ),
    headlineMedium: const TextStyle(
      // Ex: titles on the event page and songs
      fontSize: 25,
      fontStyle: FontStyle.normal,
    ...
    labelLarge: const TextStyle(
      // Ex: text on image saving snackbar
      fontSize: 16,
  ...
  inputDecorationTheme: InputDecorationTheme(
    focusedBorder:
        UnderlineInputBorder(borderSide: BorderSide(color: Colors.green[700]!)),
...
final ThemeData themePi = ThemeData(
  ...
  colorScheme: ColorScheme.fromSeed(
    ...
    onPrimaryContainer: Colors
        .white, // colors.green[700], // (only) Used for a selected element in the bottom bar
    primary: const Color.fromARGB(255, 179, 179,
        179), // used often and in random places, this is a remnant from the old theme
  ...
  primaryColorLight: Color.fromARGB(
      255, 197, 197, 197), // Used for the banner/background on the contact page

  appBarTheme:
      AppBarTheme(color: Color.fromARGB(255, 179, 179, 179)), // Top bar color
  bottomAppBarTheme:
      BottomAppBarTheme(color: Color.fromARGB(255, 179, 179, 179)),
  ...
  textTheme: TextTheme(
    ...
    titleLarge: const TextStyle(
        ...
        fontStyle: FontStyle.normal,
        color: Colors
            .black // This color is not inhereted by the titles on the top bar
        ),
    headlineMedium: const TextStyle(
      // Ex: titles on the event page and songs
      fontSize: 25,
  ...
  textButtonTheme: TextButtonThemeData(
    style: ButtonStyle(
      backgroundColor:
          MaterialStateProperty.all<Color>(Color.fromARGB(255, 245, 147, 35)),
  ...
  inputDecorationTheme: InputDecorationTheme(
    focusedBorder: UnderlineInputBorder(
        borderSide: BorderSide(color: Color.fromARGB(255, 245, 147, 35))),
...
final ThemeData themeF = ThemeData(
  ...
  colorScheme: ColorScheme.fromSeed(
    ...
    primary: Colors.orange[
        600], // colors.orange[600], used unsparingly and in random places, I just ported it over
    brightness: Brightness.light,
  ...
  primaryColorLight: const Color.fromRGBO(251, 140, 0,
      1), //Colors.orange[600] // Used for the banner/background on the contact page

  appBarTheme: AppBarTheme(color: Colors.orange[700]), // Top bar color
  bottomAppBarTheme:
      BottomAppBarTheme(color: Colors.orange[800]), // Bottom bar color
  ...
  textTheme: TextTheme(
    displayMedium: const TextStyle(
        ...
        fontFamily: 'Helvetica Neue'),
    titleLarge: const TextStyle(
        // Ex: all titles on top bar, titles of gallery albums
        fontSize: 22,
        fontStyle: FontStyle.normal,
        fontFamily: 'Helvetica Neue'),
    headlineMedium: const TextStyle(
    ...
    labelMedium: const TextStyle(
        // Ex: text on author of news in news card list
        fontSize: 14,
        fontWeight: FontWeight.bold,
        fontFamily: 'Helvetica Neue'),
  ),
...
final ThemeData themeFdark = ThemeData(
  ...
  useMaterial3: true,
  colorScheme: ColorScheme.fromSeed(
    seedColor: const Color.fromRGBO(245, 124, 0, 1), // colors.green[700]
    brightness: Brightness.dark,
    onPrimary: Colors.white, // Used for a unselected element in the bottom bar
    onPrimaryContainer: Colors
        .black, // colors.green[700], // (only) Used for a selected element in the bottom bar
    primary: const Color.fromRGBO(245, 124, 0,
        1), // colors.green[700], used often and in random places, this is a remnant from the old theme
    ...
    // Used as background for cards, like event cards in calendar, notification cards, items on "other" page
    surface: Color.fromRGBO(57, 50, 42, 1),
    onBackground: Colors.white,
    onSecondary: Colors.white,
  ...
  primaryColorLight: Color.fromRGBO(
      186, 83, 19, 1), // Used for the banner/background on the contact page

  appBarTheme:
      AppBarTheme(color: Color.fromRGBO(235, 113, 37, 1)), // Top bar color
...
final ThemeData themeO = ThemeData(
  useMaterial3: true,
  colorScheme: ColorScheme.fromSeed(
    seedColor: Color.fromARGB(255, 108, 37, 5), // Colors.deepOrange[900]
    brightness: Brightness.dark,
    onPrimary: Colors.white, // Used for a unselected element in the bottom bar
    onPrimaryContainer: const Color.fromRGBO(191, 54, 12,
        1), // Colors.deepOrange[900], (only) Used for a selected element in the bottom bar
    surfaceTint: Color.fromRGBO(51, 26, 3,
        1), // Used, ex. for the background of the cafe shifts/the notification cards
    onInverseSurface: Colors.white, // Used, ex. for the text on the cafe shifts
  ),
    ...
    focusedBorder: UnderlineInputBorder(
        borderSide: BorderSide(
            color: const Color.fromRGBO(
                191, 54, 12, 1))), // Colors.deepOrange[900]
    labelStyle: TextStyle(
        color: const Color.fromRGBO(191, 54, 12, 1)), // Colors.deepOrange[900]
    hintStyle: TextStyle(color: Colors.grey[600]), // Colors.grey[600]
...
final ThemeData themeD = ThemeData(
  ...
  colorScheme: ColorScheme.fromSeed(
    ...
    onPrimaryContainer: Colors
        .black, // colors.green[700], // (only) Used for a selected element in the bottom bar
    primary: Color(
        0xFFF280A1), // used often and in random places, this is a remnant from the old theme
  ...
  primaryColorLight: Color.fromRGBO(
      236, 143, 170, 1), // Used for the banner/background on the contact page
  ...
  inputDecorationTheme: InputDecorationTheme(
    focusedBorder:
        UnderlineInputBorder(borderSide: BorderSide(color: Color(0xFFF280A1))),
    labelStyle: TextStyle(color: Color(0xFFF280A1)),
    hintStyle: TextStyle(color: Colors.grey[600]), // Colors.grey[600]
    floatingLabelStyle:
        TextStyle(color: Color(0xFFF280A1)), // Colors.deepOrange[900]
    iconColor: Colors.grey[600],
  ),
...
final ThemeData themeV = ThemeData(
  ...
  colorScheme: ColorScheme.fromSeed(
    ...
    onPrimary: Colors.black, // Used for a unselected element in the bottom bar
    onPrimaryContainer: Colors
        .blue[700]!, // (only) Used for a selected element in the bottom bar
    surfaceTint: Colors.lightBlue[
        50], // Used, ex. for the background of the cafe shifts/the notification cards
    onInverseSurface: Colors.black, // Used, ex. for the text on the cafe shifts
  ),
  ...
  inputDecorationTheme: InputDecorationTheme(
    focusedBorder: UnderlineInputBorder(
        borderSide:
            BorderSide(color: Colors.blue[600]!)), // Colors.deepOrange[900]
    labelStyle: TextStyle(color: Colors.blue[600]!), // Colors.deepOrange[900]
    hintStyle: TextStyle(color: Colors.grey[600]), // Colors.grey[600]
    floatingLabelStyle:
        TextStyle(color: Colors.blue[600]!), // Colors.deepOrange[900]
    iconColor: Colors.grey[600],
  ),
