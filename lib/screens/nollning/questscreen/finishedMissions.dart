...
class finishedMissions extends StatefulWidget {
  @override
  _finishedMissionsState createState() => _finishedMissionsState();
}

class _finishedMissionsState extends State<finishedMissions> {
  ...
  void initState() {
    ...
    locator<NollningService>().getAdventures().then((value) => setState(() {
          ...
          maxTotalPoints = _getMaxTotal(adventureData);
        }));
    super.initState();
  }
...
int _getMaxTotal(AdventureData? adventureData) {
