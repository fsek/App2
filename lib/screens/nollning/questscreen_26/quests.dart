...
class _QuestScreenState extends State<QuestScreen>
  ...
  String start = "assets/data/nollning_26/uppdrag/bricka-start.png";
  String pelare_left = "assets/data/nollning_26/uppdrag/halvpelare_left.png";
  String pelare_right = "assets/data/nollning_26/uppdrag/halvpelare_right.png";
  String rubrik = "assets/data/nollning_26/uppdrag/rubrik.png";
  String locked = "assets/data/nollning_26/uppdrag/bricka_låst.png";
  ...
  int _checkNollningWeek() {
    return WeekTracker.determineWeek() + 1;
  }

  bool _isMissionLocked(AdventureMissionRead mission) {
    if (mission.unlockCode == null) return false;
    final entered = _enteredUnlockCodes[mission.id];
    if (entered == null) return true;
    return entered.toLowerCase() != mission.unlockCode!.toLowerCase();
  }

  void _submitUnlockCode(
    AdventureMissionRead mission,
    String code,
    BuildContext dialogContext,
  ) {
    setState(() {
      _enteredUnlockCodes[mission.id] = code;
    });
    _storage.write(key: "unlock_code_${mission.id}", value: code);
  ...
  Future<void> _loadPersistedUnlockCodes(
    ...
    for (final mission in missions) {
      ...
      final stored = await _storage.read("unlock_code_${mission.id}");
      if (stored != null) {
                    ...
                    child: TabBar(
                      ...
                      tabs: [
                        ...
                        if (DateTime.now().isAfter(
                          DateTime(2025, 8, 24, 23, 59, 59),
                        )) // This is cursed but i cba
                          Tab(text: t.localeName == "sv" ? "V0" : "W0"),
                        if (DateTime.now().isAfter(
                          DateTime(2025, 8, 31, 23, 59, 59),
                        ))
                          Tab(text: t.localeName == "sv" ? "V1" : "W1"),
                        if (DateTime.now().isAfter(
                          DateTime(2025, 9, 7, 23, 59, 59),
                        ))
                          Tab(text: t.localeName == "sv" ? "V2" : "W2"),
                        if (DateTime.now().isAfter(
                          DateTime(2025, 9, 14, 23, 59, 59),
                        ))
                          Tab(text: t.localeName == "sv" ? "V3" : "W3"),
                        if (DateTime.now().isAfter(
                          DateTime(2025, 9, 21, 23, 59, 59),
                        ))
                          Tab(text: t.localeName == "sv" ? "V4" : "W4"),
                      ],
                    ),
                        ...
                        ? t.localeName == "sv"
                              ? "Du behöver en kod för att låsa upp detta uppdrag!" +
                                    (mission.unlockHintSv != null
                                        ...
                                        : "")
                              : "You need a code to unlock this mission!" +
        ...
        Container container = Container(
          ...
          child: Card(
            ...
            child: InkWell(
              ...
              child: Stack(
                children: [
                  Positioned.fill(child: Image.asset(locked, fit: BoxFit.fill)),
                  Column(
                    children: [
              ...
              child: Card(
                ...
                child: InkWell(
                  ...
                  child: Stack(
                    children: [
                      Positioned.fill(
                        child: Image.asset(avklarad, fit: BoxFit.fill),
                      ),
                      Column(
                        children: [
                          SizedBox(height: widget.availableHeight / 50),
              ...
              child: Card(
                ...
                child: InkWell(
                  ...
                  child: Stack(
                    children: [
                      Positioned.fill(
                        child: Image.asset(misslyckad, fit: BoxFit.fill),
                      ),
                      Column(
                        children: [
                          SizedBox(height: widget.availableHeight / 50),
              ...
              child: Card(
                ...
                child: InkWell(
                  ...
                  child: Stack(
                    children: [
                      Positioned.fill(
                        child: Image.asset(bedomning, fit: BoxFit.fill),
                      ),
                      Column(
                        children: [
                          SizedBox(height: widget.availableHeight / 50),
