...
class _NolleGuideHomeState extends State<NolleGuideHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    String spindelnat = "assets/data/nollning_25/nolleguide/homescreen/spindelnat.png";
    String stod = "assets/data/nollning_25/nolleguide/homescreen/stod_${t.localeName}.png";
    String studentlivet = "assets/data/nollning_25/nolleguide/homescreen/studentlivet_${t.localeName}.png";
    String urna = "assets/data/nollning_25/nolleguide/homescreen/urna.png";
    String vett = "assets/data/nollning_25/nolleguide/homescreen/vettoetikett_${t.localeName}.png";
            ...
            children: [
              ...
              Stack(
                children: [
                  ...
                  Center(child:
                  Padding(
                    padding: t.localeName == "sv" ? EdgeInsets.only(top: 30) : EdgeInsets.only(top: 40),
                    child: Text(
                      t.nolleguide,
                      style: TextStyle(
                        letterSpacing: 2,
                        ...
                        fontSize: t.localeName == "sv" ? screenWidth / 9 : screenWidth / 14
                      ),
                    )
                  ))
                ],
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsets.only(top: screenHeight/18, left: 25),
                            child: Image.asset(spindelnat, width: screenWidth/2.5,),
                            )
                        )
                      ],
                    )
                          ...
                          child: Stack(
                            children: [
                              ...
                              Row(
                                children: [
                                  Padding(
                                    padding: EdgeInsets.only(top: screenWidth/4.5, left: 50),            
                                    child: Container(
                                      height: screenHeight/7.8,
                                      // width: screenWidth/4,
                                      child: InkWell(
                                        onTap: () => (),
                                        child: Image.asset(urna, fit: BoxFit.contain,)
                                      )
                                    ),
                                  ),
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: InkWell(
                                          onTap: () => (),
                                          child: Image.asset(studentlivet, fit: BoxFit.contain),
                                        ),
                                      ),
                                    ),
                                  )
