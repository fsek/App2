...
class AdventureMissionsTabNew extends StatefulWidget {
  @override
  _AdventureMissionsTabNewState createState() => _AdventureMissionsTabNewState();
}

class _AdventureMissionsTabNewState extends State<AdventureMissionsTabNew> {
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          flexibleSpace: new Column(
            ...
            children: [
              new TabBar(
                indicatorColor: Color.fromARGB(255, 135, 48, 48),
                labelColor: Color.fromARGB(255, 126, 97, 62),
                // Color(0xFFE9CA97),
  ...
  Color _getTileColor(AdventureMission mission) {
    if (mission.is_accepted!) {
      return Color.fromARGB(255, 62, 91, 46);
    } else if (mission.is_pending!) {
      return Color.fromARGB(255, 159, 126, 6);
    ...
    // } else if (mission.is_pending!) {
    //   return Color.fromARGB(255, 212, 175, 55);
    // } else if (mission.locked ?? false) {
    //   return Color.fromARGB(255, 125, 30, 30);
    // } else {
  ...
  Widget _getIcon(AdventureMission mission) {
    if (mission.locked ?? false) {
      return Icon(
        Icons.lock,
        color: Color.fromARGB(255, 126, 97, 62),
      );
      ...
      return Icon(
        ...
        color: Color.fromARGB(255, 73, 109, 54),
      );
    }
  }
