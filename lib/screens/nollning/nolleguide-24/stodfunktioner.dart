                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () {_launchPhoneNumber(t.careerCounsellorOneNumber);}, 
                            ...
                            ElevatedButton(
                              onPressed: () {_launchMail(t.careerCounsellorOneEmail);}, 
                              style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () {_launchPhoneNumber(t.careerCounsellorTwoNumber);}, 
                                  style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            ElevatedButton(
                              onPressed: () {_launchMail(t.careerCounsellorTwoEmail);}, 
                              style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () {_launchPhoneNumber(t.careerCounsellorThreeNumber);}, 
                                  style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            ElevatedButton(
                              onPressed: () {_launchMail(t.careerCounsellorThreeEmail);}, 
                              style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () {_launchPhoneNumber(t.studentHealthCenterNumber);}, 
                                  style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                              ...
                              ElevatedButton(
                              onPressed: () {_launchAdress(t.studentHealthCenterAdress);}, 
                              style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  t.presidentOfStudentEqualityComittee,
                                  style: TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: screenWidth/28
                                  )
                                ...
                                ElevatedButton(
                              onPressed: () {_launchMail(t.presidentOfStudentEqualityComitteeEmail);}, 
                              style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                              onPressed: () {_launchMail(t.masterOfConscienceEmail);}, 
                              style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {_launchMail(t.libuEmail);}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            ElevatedButton(
                                onPressed: () {(launchUrl(Uri.parse(t.guildAnonContactPage)));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                      ...
                      child:
                        Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                                onPressed: () {(launchUrl(Uri.parse(t.complainPage)));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.supportThereIsHelpNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                              ...
                              ElevatedButton(
                                onPressed: () {(_launchMail(t.supportThereIsHelpEmail));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.umoNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.psychotherapyClinicNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                              ...
                              ElevatedButton(
                                onPressed: () {(_launchMail(t.psychotherapyClinicEmail));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.youngAdultsInLundNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.studentPriestsNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            ElevatedButton(
                                onPressed: () {(_launchMail(t.studentPriestsEmail));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            SizedBox(height: 10),
                            ElevatedButton(
                                onPressed: () {(launchUrl(Uri.parse(t.girlAndTransgenderHotlineLundWebsite)));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.kvinnojourenLundNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            ElevatedButton(
                                onPressed: () {(_launchMail(t.kvinnojourenLundEmail));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.mansjourenNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            ElevatedButton(
                                onPressed: () {(launchUrl(Uri.parse(t.mansjourenWebsite)));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.adultPsychEmergencyClinicNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.mindSuicidehotliteNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.onCallPersonNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.mariaClinicNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            ElevatedButton(
                                onPressed: () {(launchUrl(Uri.parse(t.skaneVardWebsite)));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber(t.triangleAddictionClinicNumber));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                onPressed: () {(_launchPhoneNumber('114 14'));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
                      ...
                      child:
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 20),
                            ElevatedButton(
                                onPressed: () {(_launchMail(t.overfosEmail));}, 
                                style: ElevatedButton.styleFrom(
                                    padding: EdgeInsets.only(),
                                    shape: BeveledRectangleBorder(
                                      borderRadius: BorderRadius.horizontal()
