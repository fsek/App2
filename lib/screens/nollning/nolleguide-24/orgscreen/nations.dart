        ...
        children: [
          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  Center(child: Text(t.nations, style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Testament", fontSize: screenWidth / 10, color: Color(0xFF540909)))),
                  SizedBox(height: 10),
                  Text(
                    t.nationsInfo,
                    style: TextStyle(
                  ...
                  ElevatedButton(
                      onPressed: () {
                        launchUrl(Uri.parse(t.nationsWebsite));
                      },
                      ...
                      child: Text(t.nationsWebsite, style: TextStyle(fontWeight: FontWeight.w500, color: Color(0xFF5269D1), fontSize: screenWidth / 25)))
                ],
              ))
        ],
      ))),
