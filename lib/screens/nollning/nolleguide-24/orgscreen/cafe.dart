...
class CafeScreenPage extends StatefulWidget {
  @override
...
class _CafeScreenState extends State<CafeScreenPage> {
  List<Person> people = [];
  ...
  Future<List<Person>> _loadPeople() async {
    final String raw =
        await rootBundle.loadString('assets/data/nolleguide_2024/cafe.json');
