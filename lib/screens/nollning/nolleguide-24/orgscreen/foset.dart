...
class FosetScreenPage extends StatefulWidget {
  @override
  _FosetScreenState createState() => _FosetScreenState();
}



class _FosetScreenState extends State<FosetScreenPage> {
  List<Person> people = [];
  ...
  Future<List<Person>> _loadPeople() async {
    final String raw =
        await rootBundle.loadString('assets/data/nolleguide_2024/foset.json');
