...
class _OthersScreenState extends State<OthersScreenPage> {
  ...
  Future<List<Article>> _loadArticles() async {
    final String raw = await rootBundle.loadString('assets/data/nolleguide_2024/ovriga.json');
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Center(
                          child: Text(articles[0].title![t.localeName]!, style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Testament", fontSize: screenWidth / 12, color: Color(0xFF540909))),
                        ),
                        SizedBox(height: 10),
                        Text(
                        ...
                        ElevatedButton(
                            onPressed: () {
                              launchUrl(Uri.parse(t.utskottWebsite));
                            },
                            ...
                            child: Text(t.utskottWebsite, style: TextStyle(fontWeight: FontWeight.w500, color: Color(0xFF5269D1), fontSize: screenWidth / 29)))
                      ]))
                ],
              ))));
  }
