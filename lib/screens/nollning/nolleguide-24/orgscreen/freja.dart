...
class FrejaScreenPage extends StatefulWidget {
  @override
  _FrejaScreenState createState() => _FrejaScreenState();
}



class _FrejaScreenState extends State<FrejaScreenPage> {
  List<Person> people = [];
  ...
  Future<List<Person>> _loadPeople() async {
    final String raw =
        await rootBundle.loadString('assets/data/nolleguide_2024/freja.json');
