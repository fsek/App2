...
class _ManagementScreenState extends State<ManagementScreenPage> {
  List<Person> people = [];
  ...
  Future<List<Person>> _loadPeople() async {
    final String raw =
        await rootBundle.loadString('assets/data/nolleguide_2024/management.json');
