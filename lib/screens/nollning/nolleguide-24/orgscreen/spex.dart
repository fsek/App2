                    ...
                    child: Column(
                      ...
                      children: [
                        Center(
                            child: Text(
                          t.spexInLund,
                          style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Testament", fontSize: screenWidth / 11, color: Color(0xFF540909)),
                        )),
                        SizedBox(height: 10),
                        Text(
                          t.spexContent,
                          style: TextStyle(fontWeight: FontWeight.w500, fontSize: screenWidth / 28, color: Color(0xFF540909)),
                        ),
                        SizedBox(height: 50),
                        Row(
                          children: [Expanded(child: Image.asset(i1)), SizedBox(width: 10), Expanded(child: Image.asset(i2))],
                        ),
                        SizedBox(height: 10),
                        Text(
                          t.spexImageText,
                        ...
                        Center(
                            child: Text(
                          t.spexCredits,
                          style: TextStyle(fontSize: screenWidth / 28, fontStyle: FontStyle.italic, color: Color(0xFF540909)),
                        ))
                      ],
                    ))
              ],
