                      ...
                      Column(
                        children: [
                          Container(
                              ...
                              child: Text(
                                t.kladguideTopTitle,
                                style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Testament", fontSize: screenWidth / 28, color: Color(0xFF540909)),
                              )),
                          Container(
                              margin: EdgeInsets.only(left: 130),
                              child: Text(
                                t.kladGuideProcessionFeature,
                                style: TextStyle(fontWeight: FontWeight.w400, fontSize: screenWidth / 31, color: Color(0xFF540909)),
                              )),
                          SizedBox(height: 20),
                          Container(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                SizedBox(height: 20),
                                Text(t.kladGuideWhiteTieFullDress,
                                    style: TextStyle(
                            ...
                            Row(
                              children: [
                                Expanded(
                                  ...
                                  SizedBox(height: 5),
                                  Text(t.ovveThematicallyContent,
                                      style: TextStyle(
                                        fontWeight: FontWeight.w500,
                                        fontSize: screenWidth / 34,
                                      )),
                                ...
                                SizedBox(width: 10),
                                Expanded(child: Image.asset(i4))
                              ],
                            ),
                            SizedBox(height: 100),
                            Text(t.technologistCap,
                                style: TextStyle(
                                  fontFamily: "Testament",
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFF540909),
