...
class _SettingsPageState extends State<SettingsPage> {
                ...
                Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          _makeDropDown<int>(
                              "Startår", years, () => user!.start_year, (year) {
                            setState(() {
  ...
  Widget Function(BuildContext) _savingPopup() {
    return (BuildContext context) => SimpleDialog(
            title: Text("Sparar", style: Theme.of(context).textTheme.headline5),
            children: [
              Column(
                children: [
  ...
  Widget Function(BuildContext) _failedPopup() {
    return (BuildContext context) => SimpleDialog(
            title:
                Text("Varning", style: Theme.of(context).textTheme.headline5),
            children: [
              Center(
                child: Padding(
                  padding: EdgeInsets.all(8),
