...
class _ContactPageState extends State<ContactPage> {
  ...
  Widget build(BuildContext context) {
    ...
    ); //default box decoration, could add image for flair
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Html(
                data: currentContact!.text!,
              ), //Make into html when that dependency is merged
            ),
            Container(
              width: double.infinity,
              decoration: BoxDecoration(color: Colors.grey[200]),
  ...
  void _successPopup() {
    ...
    showDialog(
      context: context,
      builder: _popUp("Yay!!", t.contactHasBeenSent),
    );
  }
  ...
  void _failPopup() {
    ...
    showDialog(
      context: context,
      builder: _popUp("Oh no!", t.contactHasNotBeenSent),
    );
  }
