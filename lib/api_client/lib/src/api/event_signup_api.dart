...
class EventSignupApi {
  ...
  const EventSignupApi(this._dio, this._serializers);
  ...
  Future<Response<EventSignupRead>> eventSignupEventSignoffRoute({ 
    ...
    final _path = r'/event-signup/{event_id}'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(int)).toString());
  ...
  Future<Response<EventSignupRead>> eventSignupEventSignupRoute({ 
    ...
    try {
      const _type = FullType(EventSignupCreate);
      _bodyData = _serializers.serialize(eventSignupCreate, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [EventSignupRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventSignupRead>> eventSignupGetMeEventSignup({ 
    required int eventId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/event-signup/me-signup/{event_id}'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<EventSignupRead>> eventSignupUpdateEventSignupRoute({ 
    ...
    try {
      const _type = FullType(EventSignupUpdate);
      _bodyData = _serializers.serialize(eventSignupUpdate, specifiedType: _type);
