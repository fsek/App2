...
class AccessServeApi {

  final Dio _dio;

  final Serializers _serializers;

  const AccessServeApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<String>>> accessServeGetAllAccessIds({ 
    ...
    final _path = r'/access-serve/{door}'.replaceAll('{' r'door' '}', encodeQueryParameter(_serializers, door, const FullType(String)).toString());
