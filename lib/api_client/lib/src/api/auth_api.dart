...
class AuthApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BearerResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BearerResponse>> authAuthCookieLogin({ 
    ...
    BearerResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BearerResponse),
      ) as BearerResponse;
    ...
    return Response<BearerResponse>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> authAuthCookieLogout({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> authAuthCookieLogoutAll({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [BearerResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BearerResponse>> authAuthCookieRefresh({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserRead>> authAuthCookieUpdateEmail({ 
    ...
    final _path = r'/auth/update-email';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = <String, dynamic>{
        r'new_email': encodeQueryParameter(_serializers, newEmail, const FullType(String)),
        r'grant_type': encodeQueryParameter(_serializers, grantType, const FullType(String)),
        r'username': encodeQueryParameter(_serializers, username, const FullType(String)),
        r'password': encodeQueryParameter(_serializers, password, const FullType(String)),
        if (scope != null) r'scope': encodeQueryParameter(_serializers, scope, const FullType(String)),
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> authAuthCookieUpdatePassword({ 
    ...
    final _path = r'/auth/update-password';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [UserRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserRead>> authRegisterRegister({ 
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> authResetForgotPassword({ 
    required BodyAuthResetForgotPassword bodyAuthResetForgotPassword,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BodyAuthResetForgotPassword);
      _bodyData = _serializers.serialize(bodyAuthResetForgotPassword, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> authResetResetPassword({ 
    required BodyAuthResetResetPassword bodyAuthResetResetPassword,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BodyAuthResetResetPassword);
      _bodyData = _serializers.serialize(bodyAuthResetResetPassword, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> authVerifyRequestToken({ 
    required BodyAuthVerifyRequestToken bodyAuthVerifyRequestToken,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/request-verify-token';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BodyAuthVerifyRequestToken);
      _bodyData = _serializers.serialize(bodyAuthVerifyRequestToken, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [UserRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserRead>> authVerifyVerify({ 
    required BodyAuthVerifyVerify bodyAuthVerifyVerify,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BodyAuthVerifyVerify);
      _bodyData = _serializers.serialize(bodyAuthVerifyVerify, specifiedType: _type);
