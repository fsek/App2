...
class EventsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AddEventTag] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AddEventTag>> eventsAddTagToEvent({ 
    required AddEventTag addEventTag,
    ...
    try {
      const _type = FullType(AddEventTag);
      _bodyData = _serializers.serialize(addEventTag, specifiedType: _type);
    ...
    AddEventTag? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AddEventTag),
      ) as AddEventTag;
  ...
  Future<Response<EventRead>> eventsConfirmEventUsers({ 
    ...
    final _path = r'/events/event-confirm-event-users/{event_id}'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(int)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [EventRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventRead>> eventsCreateEvent({ 
  ...
  /// Returns a [Future] containing a [Response] with a [EventRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventRead>> eventsEventRemove({ 
    required int eventId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/events/{event_id}'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [EventRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventRead>> eventsEventUpdate({ 
    required int eventId,
  ...
  Future<Response<BuiltList<EventSignupRead>>> eventsGetAllEventSignups({ 
    ...
    final _path = r'/events/event-signups/all/{event_id}'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<EventRead>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<EventRead>>> eventsGetAllEvents({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<EventRead>? _responseData;
    ...
    return Response<BuiltList<EventRead>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> eventsGetEventCsv({ 
    required int eventId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/events/event-signups/confirmed/{event_id}/csv'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> eventsGetEventImageStream({ 
    required int eventId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/events/{event_id}/image/stream'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<String>>> eventsGetEventPriorities({ 
    ...
    final _path = r'/events/priorities';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<EventTagRead>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<EventTagRead>>> eventsGetEventTags({ 
    required int eventId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/events/get-event-tags/{event_id}'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<EventTagRead>? _responseData;
    ...
    return Response<BuiltList<EventTagRead>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [EventRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventRead>> eventsGetSingleEvent({ 
    required int eventId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/events/{eventId}'.replaceAll('{' r'eventId' '}', encodeQueryParameter(_serializers, eventId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> eventsPostEventImage({ 
    required int eventId,
