...
class CarsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AdminCarBookingRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminCarBookingRead>> carsAdminGetCarBooking({ 
    ...
    final _path = r'/car/admin/{booking_id}'.replaceAll('{' r'booking_id' '}', encodeQueryParameter(_serializers, bookingId, const FullType(int)).toString());
    ...
    AdminCarBookingRead? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminCarBookingRead),
      ) as AdminCarBookingRead;
    ...
    return Response<AdminCarBookingRead>(
      data: _responseData,
  ...
  Future<Response<CarBookingRead>> carsGetCarBooking({ 
    ...
    final _path = r'/car/{booking_id}'.replaceAll('{' r'booking_id' '}', encodeQueryParameter(_serializers, bookingId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
