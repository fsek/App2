...
class UsersApi {
  ...
  Future<Response<BuiltList<UserRead>>> usersGetAllUsers({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserRead>> usersGetMe({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<JsonObject>> usersUpdateUser({ 
    ...
    final _path = r'/users/member-status/{user_id}'.replaceAll('{' r'user_id' '}', encodeQueryParameter(_serializers, userId, const FullType(int)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
