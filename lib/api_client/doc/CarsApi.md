...
------------- | ------------- | -------------
[**carsAdminGetCarBooking**](CarsApi.md#carsadmingetcarbooking) | **GET** /car/admin/{booking_id} | Admin Get Car Booking
...
# **carsAdminGetCarBooking**
> AdminCarBookingRead carsAdminGetCarBooking(bookingId)
...
try {
    final response = api.carsAdminGetCarBooking(bookingId);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CarsApi->carsAdminGetCarBooking: $e\n');
}
```
...
[**AdminCarBookingRead**](AdminCarBookingRead.md)
