...
[**imgGetAlbumImages**](ImgApi.md#imggetalbumimages) | **GET** /img/album/{album_id} | Get Album Images
[**imgGetImage**](ImgApi.md#imggetimage) | **GET** /img/images/{img_id}/{size} | Get Image
...
# **imgGetAlbumImages**
> BuiltList<int> imgGetAlbumImages(albumId)
