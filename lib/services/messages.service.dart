...
class MessagesService extends AbstractService {
  ...
  Future<List<MessagingGroup>> getGroups() async {
    ...
    List<MessagingGroup> result = (json['groups'] as List)
        .map((data) => MessagingGroup.fromJson(data))
        .toList();
    return result;
  }
  ...
  Future<List<Message>> getMessages(int groupId) async {
    ...
    List<Message> result = (json['messages'] as List)
  ...
  Future<List<Message>> getMoreMessages(
    ...
    Map json =
        await AbstractService.get("/groups/$groupId/messages?page=$page");
    List<Message> result = (json['messages'] as List)
        .map((data) => Message.fromJson(data))
        .toList();
    pageCount = json["meta"]["total_pages"];
