...
import 'dart:convert';
  ...
  Future<void> preloadAssets(BuildContext context, String imageListName) async {
    ...
    switch(imageListName) {
      ...
      imagePaths = ["assets/img/nollning-24/nolleguide/people/festivities.jpg",];
      break;

      case "educationPaths":
      imagePaths = ["assets/img/nollning-24/nolleguide/people/education.jpg",];
      break;

      case "accountingPaths":
      imagePaths = ["assets/img/nollning-24/nolleguide/people/Treasurer.jpg",];
      break;

      case "cafePaths":
      imagePaths = ["assets/img/nollning-24/nolleguide/people/Cafe.jpg",];
      break;
      ...
      imagePaths = ["assets/img/nollning-24/nolleguide/people/pryl.jpg",];
      break;
      ...
      imagePaths = ["assets/img/nollning-24/nolleguide/people/medalj.jpg",];
      break;

      case "frejaPaths": 
      imagePaths = ["assets/img/nollning-24/nolleguide/people/FREJA.jpeg",];
      break;
