...
1. Run `bash build_openapi.sh`, which will take care of most work for you. NOTE: look through the trace to see if anything went wrong (look for errors or connection problems), the script will not tell you on its own!
